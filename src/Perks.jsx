export default function Perks({selected, onChange})
{
  ...
  function handlecbClick(ev)
  {
    ...
    return(
        ...
        <div>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 space-between">
            <label className="border p-4 flex rounded-3xl gap-2 items-center ml-3 mr-10">
            ...
            <label className = "border p-4 flex rounded-2xl gap-2 items-center mx-10">
